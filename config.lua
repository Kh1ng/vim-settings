...
-- remap tab autocompleteion to ctrl tab for copilot
--lvim.keymap.insert_mode["tab"] = false;
--lvim.keys.insert_mode["<C-tab>"] =
--"<Lua 613: ~/.local/share/lunarvim/site/pack/packer/start/nvim-cmp/lua/cmp/utils/keymap.lua:112>"
